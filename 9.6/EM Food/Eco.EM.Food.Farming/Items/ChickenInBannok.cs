...
namespace Eco.EM.Food.Farming
{
    ...
    public partial class ChickenInBannockItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(ChickenInBannockItem), "Chicken In Bannock", shelflife: 12, calories: 1200, carbs: 14, fat: 9, protein: 15, vitamins: 5);
