...
namespace Eco.EM.Artistry
{
    ...
    {
        public override LocString DisplayDescription => Localizer.DoStr("Become a master of the arts");
    ...
    {
        public override LocString DisplayDescription => Localizer.DoStr("Doubles the speed of related tables when alone.");
