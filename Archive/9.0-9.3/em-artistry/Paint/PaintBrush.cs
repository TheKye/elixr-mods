...
namespace Eco.EM.Artistry
{
    ...
    public partial class PaintBrushRecipe : RecipeFamily
    {
        private string rName = "Paint Brush";
        ...
        public PaintBrushRecipe()
        {
            var product = new Recipe(
               rName,
                ...
                {
                    new IngredientElement("Wood", 2, skillBase, ingTalent),
                    new IngredientElement(typeof(FurPeltItem), 2, skillBase, ingTalent),
                },
                 new CraftingElement<PaintBrushItem>(2)
            );
