...
namespace Eco.EM.Building
{
    ...
    public partial class YellowReinforcedConcreteBlock :
        Block
        , IRepresentsItem
    {
        public Type RepresentedItemType { get { return typeof(YellowReinforcedConcreteItem); } }
    }
    ...
    [Tag("Constructable", 1)]
    [Tier(3)]
    public partial class YellowReinforcedConcreteItem :
    BlockItem<YellowReinforcedConcreteBlock>
    {
        public override LocString DisplayNamePlural { get { return Localizer.DoStr("Yellow Reinforced Concrete"); } }
