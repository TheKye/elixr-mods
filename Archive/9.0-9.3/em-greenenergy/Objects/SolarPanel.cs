...
namespace Eco.EM.GreenEnergy
{
    ...
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("Solar Panel used to store energy from the sun"); } }
        ...
        [Tooltip(8)] private LocString PowerProductionTooltip => Localizer.Do($"Produces: {Text.Info(250)}w of {new ElectricPower().Name} power");
    }
