...
namespace Eco.Mods.TechTree
{
    ...
    {
        // Static values
        private static IDynamicValue        caloriesBurn        = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(SteelBigShovelItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(15, typeof(SelfImprovementSkill), typeof(SteelBigShovelItem), new SteelBigShovelItem().UILink()));
