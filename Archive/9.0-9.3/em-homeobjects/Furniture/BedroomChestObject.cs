...
namespace Eco.EM.Furniture
{
    ...
    [MaxStackSize(100)]
    public partial class BedroomChestItem : WorldObjectItem<BedroomChestObject>
    {
        ...
        [TooltipChildren] public static HousingValue HousingVal => new HousingValue() { Category = HousingValue.RoomCategory.Bedroom, Val = 2, TypeForRoomLimit = "Storage", DiminishingReturnPercent = 0.5f };
    }

    [RequiresSkill(typeof(TailoringSkill), 2)]
    public partial class BedroomChestRecipe : RecipeFamily
    {
        public BedroomChestRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(BedroomChestRecipe), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));
