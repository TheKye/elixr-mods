...
namespace Eco.EM.Furniture
{
    ...
    [Tag("Housing", 1)]
    public partial class FakePlantSquareItem : WorldObjectItem<FakePlantSquareObject>
    {
    ...
    public partial class FakePlantSquareRecipe : RecipeFamily
    {
        ...
        public FakePlantSquareRecipe()
        {
            var product = new Recipe(
                ...
                new IngredientElement[]
                {
                 ...
                 new CraftingElement<FakePlantSquareItem>(1f)
            );
    ...
    public partial class FakePlantSquareObject : WorldObject, IRepresentsItem
    {
        ...
        {
            this.GetComponent<HousingComponent>().Set(FakePlantSquareItem.HousingVal);
        }
