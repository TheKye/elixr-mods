...
namespace Eco.EM.Greenhousing
{
    ...
    [Tag("Tool", 1), Ecopedia("Items", "Tools", createAsSubPage: true, display: InPageTooltip.DynamicTooltip)]
    public class GreenhouseKitItem : SoilSamplerItem
    {
        public override LocString DisplayDescription   { get { return Localizer.DoStr("Kit specifically for testing greenhouse conditions."); } }
        public override LocString LeftActionDescription { get { return Localizer.DoStr("Test Loacation"); } }
        ...
        public override InteractResult OnActLeft(InteractionContext context)
        {
            if (context.HasBlock)
            {
                ...
                if (!GreenhousingExtensions.VaildGreenhouse(target.Value, out string fail))
                {
                ...
                context.Player.OpenInfoPanel(title.ToString(), text.ToString(), "Greenhouse Kit");
