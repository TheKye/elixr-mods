...
namespace NyElectrics
{
    ...
    public partial class NyElectricBlastFurnaceObject : WorldObject, IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(NyElectricBlastFurnaceItem.HousingVal);
    ...
    public partial class NyElectricBlastFurnaceItem : WorldObjectItem<NyElectricBlastFurnaceObject>
    {
        ...
        public static HousingValue HousingVal
        {
            get
            {
                ...
                {
                    Category = HousingValue.RoomCategory.Industrial,
                    TypeForRoomLimit = "",
                };
            }
        }
    ...
    public partial class NyElectricBlastFurnaceRecipe : RecipeFamily
    {
        public NyElectricBlastFurnaceRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    ...
                    {
                        new IngredientElement(typeof(BasicCircuitItem), 1, true),
                        new IngredientElement(typeof(ScrewsItem), 40, typeof(IndustrySkill), typeof(IndustryLavishResourcesTalent)),
                        new IngredientElement(typeof(SteelBarItem), 40, typeof(IndustrySkill), typeof(IndustryLavishResourcesTalent))
                    },
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(NyElectricBlastFurnaceRecipe), 10f, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));
