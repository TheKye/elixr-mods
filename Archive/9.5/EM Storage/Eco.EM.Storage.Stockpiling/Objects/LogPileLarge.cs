...
{ 
    ...
    public partial class LogPileLargeObject : WorldObject, IRepresentsItem, ILinkRadiusObject, IStorageSlotObject
    {
        ...
        private static readonly StorageSlotModel SlotDefaults = new(typeof(LogPileLargeObject)) { StorageSlots = 28 };
        ...
        protected override void PostInitialize()
        {
            ...
            storage.Storage.AddInvRestriction(new TagRestriction(Tag.Wood.Name, "Lumber", "HewnLog"));
    ...
    {
        public override LocString DisplayDescription => Localizer.DoStr("A large pile for logs");               
