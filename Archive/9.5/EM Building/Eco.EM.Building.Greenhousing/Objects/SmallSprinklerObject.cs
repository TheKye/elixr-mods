...
namespace Eco.EM.Building.Greenhousing
{
    ...
    public partial class SmallSprinklerObject : WorldObject, IRepresentsItem
    {
        ...
        static SmallSprinklerObject()
        {
            ...
            new BlockOccupancy(new Vector3i(0, 0, 0), typeof(PipeSlotBlock), new Quaternion(-0.7071071f, 2.634177E-07f, 2.634179E-07f, 0.7071065f), "WaterInputPort")
            });
        }
        ...
        {
            this.GetComponent<LiquidConsumerComponent>().Setup(typeof(WaterItem), 0.3f, NamedOccupancyOffset("WaterInputPort"), 0.3f);
            base.PostInitialize();
        }
