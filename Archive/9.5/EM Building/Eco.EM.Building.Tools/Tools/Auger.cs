...
namespace Eco.EM.Building.Tools
{
    ...
    public partial class AugerItem : ShovelItem
    {
        ...
        // Static values
        private static readonly IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(AugerItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(10, typeof(SelfImprovementSkill), typeof(AugerItem)));
        ...
        public override InteractResult OnActLeft(InteractionContext context)
        {
            if (this.Durability == 0)
                return InteractResult.Failure(Localizer.DoStr("The Auger has run out of gas, it needs to be refuled.."));
