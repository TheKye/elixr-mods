    ...
    public partial class WarpPointObject : WorldObject, IRepresentsItem
    {
       ...
       [Serialized] private string NameRollback { get; set; } = "new point";
        ...
        protected override void Initialize()
        {
            ...
            { 
                var pointName = StringUtils.Sanitize(GivenName);
                ...
                else
                {
                    ...
                    ChatBaseExtended.CBError(Defaults.appName + $"The community warp point {NameRollback} has been renamed to {pointName}");
