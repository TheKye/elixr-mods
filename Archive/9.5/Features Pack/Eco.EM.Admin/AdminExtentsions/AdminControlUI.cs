...
namespace Eco.EM.Admin.AdminExtentsions
{
    public class AdminControlUI
    {
        ...
        public static LocString DisplayUserAdminInformation(User user)
        {
            ...
            var ip = user.Client.Connection.GetPropertyByName<IPEndPoint>("RemoteEndPoint").Address.ToString();
            ...
            statsDisplay.Append("Is Admin: " + string.Format(user.IsAdmin ? GreenText("Yes") : RedText("No")) + "\n");
