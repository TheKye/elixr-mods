...
{
    public class AFKPlugin : Singleton<AFKPlugin>, IModKitPlugin, IChatCommandHandler, IInitializablePlugin
    {
        ...
        public NLogWriter logger = LoggingUtils.RegisterNewLogger("EM-AFK");
