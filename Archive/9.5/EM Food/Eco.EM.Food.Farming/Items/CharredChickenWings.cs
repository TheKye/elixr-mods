...
namespace Eco.EM.Food.Farming
{
    ...
    public partial class CharredChickenWingsItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(CharredChickenWingsItem), "Charred Chicken Wings", calories: 300, carbs: 0, fat: 5, protein: 6, vitamins: 0);
