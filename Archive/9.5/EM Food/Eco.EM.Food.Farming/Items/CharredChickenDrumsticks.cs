...
namespace Eco.EM.Food.Farming
{
    ...
    public partial class CharredChickenDrumsticksItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(CharredChickenDrumsticksItem), "Charred Chicken Drumsticks", calories: 400, carbs: 0, fat: 5, protein: 6, vitamins: 0);
