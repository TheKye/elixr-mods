...
namespace Eco.EM.Machines.Vehicles.ModularTruck
{
    ...
    public partial class MiningTruckRecipe : RecipeFamily
    {
        public MiningTruckRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                "MiningTruck",  //noloc
                Localizer.DoStr("Modular Truck - Mining Truck Attachment"),
                ...
                {
                    new CraftingElement<MiningTruckItem>()
                });
            this.Recipes = new List<Recipe> { recipe };
            this.ExperienceOnCraft = 10;
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(MechanicsSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(MiningTruckRecipe), 6, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Modular Truck - Mining Truck Attachment"), typeof(MiningTruckRecipe));
    ...
    [Serialized]
    [LocDisplayName("Modular Truck - Mining Truck Attachment")]
    [Weight(10000)]
    [Ecopedia("Items", "Tools", createAsSubPage: true, display: InPageTooltip.DynamicTooltip)]
    public partial class MiningTruckItem : VehicleToolItem
    {
