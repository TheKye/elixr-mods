...
namespace Eco.EM.Framework.Resolvers
{
    ...
    public class EMConfigurePlugin : Singleton<EMConfigurePlugin>, IModKitPlugin, IConfigurablePlugin, IModInit, IChatCommandHandler
    {
        ...
        public string GetStatus() => $"Loaded EM Configure";
