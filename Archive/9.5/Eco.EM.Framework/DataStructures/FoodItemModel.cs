...
namespace Eco.EM.Framework.Resolvers
{
    ...
    public class FoodItemModel : ModelBase
    {
        ...
        public FoodItemModel(Type type, string displayName, float carbs, float fat, float protein, float vitamins, float calories)
        {
            ModelType = type.Name;
        ...
        [JsonConstructor]
        public FoodItemModel(string modelType, string assembly, float carbs, float fat, float protein, float vitamins, float calories, string displayName)
        {
            ModelType = modelType;
            Assembly = assembly;
            Carbs = carbs;
