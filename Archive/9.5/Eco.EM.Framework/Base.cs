...
namespace Eco.EM.Framework
{
    public static class Defaults
    {
        ...
        {
            bool createNew = string.IsNullOrWhiteSpace(Path);
            switch (createNew)
            {
                case true:
                    {
                        ...
                        {
                            Log.WriteLine(Localizer.DoStr("Directory For Mod Config Files does not Exist, Generating it now."));
                ...
                case false:
                    {
                        ...
                        {
                            Log.WriteLine(Localizer.DoStr($"{Path} Does not exist, Generating it now."));
