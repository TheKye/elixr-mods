...
namespace Eco.EM.Artistry
{
    ...
    {
        public override LocString DisplayDescription => Localizer.DoStr("White Paint Used for Painting Certain Items.");
    }

    [RequiresSkill(typeof(PaintingSkill), 2)]
    public partial class WhitePaintRecipe : RecipeFamily, IConfigurableRecipe
    {
        static RecipeDefaultModel Defaults => new()
        {
            ModelType = typeof(WhitePaintRecipe).Name,
            Assembly = typeof(WhitePaintRecipe).AssemblyQualifiedName,
            HiddenName = "Paint Base - White",
            LocalizableName = Localizer.DoStr("Paint Base - White"),
            IngredientList = new()
            {
            ...
            ProductList = new()
            {
                new EMCraftable("WhitePaintItem", 4),
            },
        ...
        static WhitePaintRecipe() { EMRecipeResolver.AddDefaults(Defaults); }
