...
namespace Eco.EM.Warp
{
    ...
    public class WarpData
    {
        ...
        internal bool AddPoint(string pointName, System.Numerics.Vector3 loc, Quaternion rot)
        {           
        ...
        internal bool ChangePointName(System.Numerics.Vector3 location, string newName)
        {
