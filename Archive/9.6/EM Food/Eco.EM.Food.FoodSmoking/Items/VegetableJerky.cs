...
namespace Eco.EM.Food.FoodSmoking
{
    ...
    public partial class VegetableJerkyItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(VegetableJerkyItem), "Vegetable Jerky", shelflife: 24, calories: 400, carbs: 12, fat: 0, protein: 0, vitamins: 12);
