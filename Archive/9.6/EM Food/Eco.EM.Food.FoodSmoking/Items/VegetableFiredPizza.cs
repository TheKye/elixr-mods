...
namespace Eco.EM.Food.FoodSmoking
{
    ...
    public partial class VegetableFiredPizzaItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(VegetableFiredPizzaItem), "Vegetable Pizza", shelflife: 24, calories: 800, carbs: 10, fat: 5, protein: 5, vitamins: 10);
