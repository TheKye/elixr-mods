...
namespace Eco.EM.Food.Farming
{
    ...
    public partial class RawChickenWingsItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(RawChickenWingsItem), "Raw Chicken Wings", shelflife: 24, calories: -40, carbs: 4, fat: 6, protein: 9, vitamins: 3);
