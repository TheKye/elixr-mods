...
namespace Eco.EM.Building.Tools
{
    ...
    public partial class MaterialChiselItem : HammerItem
    {
        ...
        // Statics        
        private static readonly IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(MaterialChiselItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(8, typeof(SelfImprovementSkill), typeof(MaterialChiselItem), new MaterialChiselItem().UILink()));
        ...
        public override InteractResult OnActLeft(InteractionContext context)
        {
            ...
            if (blockItem != null)
            {
                ...
                if (context.CarriedItem != null)
                {
                    ...
                    PlaceBlockFill(context, context.TargetPosition);
                }
