...
namespace Eco.EM.Building.Tools
{
    ...
    public partial class ChiselAndBagItem : HammerItem
    {
        ...
        // Statics        
        private static readonly IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(MaterialChiselItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(8, typeof(SelfImprovementSkill), typeof(MaterialChiselItem), new ChiselAndBagItem().UILink()));
