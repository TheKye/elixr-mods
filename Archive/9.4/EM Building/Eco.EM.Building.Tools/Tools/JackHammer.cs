...
namespace Eco.EM.Building.Tools
{
    ...
    public partial class JackHammerItem : PickaxeItem
    {
        ...
        // Static values
        private static readonly IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(JackHammerItem), typeof(MiningToolEfficiencyTalent)), CreateCalorieValue(10, typeof(MiningSkill), typeof(JackHammerItem), new JackHammerItem().UILink()));
