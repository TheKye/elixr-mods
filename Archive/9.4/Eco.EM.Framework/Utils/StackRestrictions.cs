...
namespace Eco.EM.Framework.Utils
{
    ...
    public class ToolLimitRestriction : InventoryRestriction
    {
        public virtual int MaxItems { get; protected set; }
        public override LocString Message => Localizer.DoStr("This Inventory only Accepts Tools.");
        public virtual bool Enabled => this.MaxItems > 0;

        public ToolLimitRestriction()
        {
            this.MaxItems = 1;
        }
