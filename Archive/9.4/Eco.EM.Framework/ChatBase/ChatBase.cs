...
using Eco.Shared.Utils;
    ...
    public class ChatBase : IModKitPlugin
    {
        ...
        public struct Info
        {
            ...
            public Info(string content, IChatClient user)
            {
                Content = content;
                Player = UserManager.FindUser(user.Name)?.Player;
                User = UserManager.FindUser(user.Name)?.Player.User;
                chatClient = user;
                RecipientType = RecipientType.Player;
                MessageCategory = MessageCategory.Info;
            }
        ...
        public struct InfoPane
        {
            ...
            public InfoPane(string title, string content, string instance, PanelType usePanelType, bool sendToChat = false)
            {
                Title = title;
                Content = content;
                Player = null;
            ...
            public InfoPane(string title, string content, string instance, PanelType usePanelType, bool tempMessage, bool sendToChat = false)
            {
                Title = title;
                Content = content;
                Player = null;
            ...
            public InfoPane(string title, string content, string instance, User user, PanelType usePanelType, bool sendToChat = false)
            {
                Title = title;
                Content = content;
                Player = user.Player;
            ...
            public InfoPane(string title, string content, string instance, User user, PanelType usePanelType, bool tempMessage, bool sendToChat = false)
            {
                Title = title;
                Content = content;
                Player = user.Player;
            ...
            public InfoPane(string title, string content, string instance, Player player, PanelType usePanelType, bool sendToChat = false)
            {
                Title = title;
                Content = content;
                Player = player;
            ...
            public InfoPane(string title, string content, string instance, Player player, PanelType usePanelType, bool tempMessage, bool sendToChat = false)
            {
                Title = title;
                Content = content;
                Player = player;
        ...
        public static bool Send(Info Message)
        {
            switch (Message.RecipientType)
            {
                ...
                case RecipientType.ChatClient:
                    if (Message.Player != null)
                        return SendToPlayer(Message);
                    return SendToRcon(Message);
            }

            return false;
        }

        internal static bool SendToRcon(Info Message)
        {
            Message.chatClient.MsgLocStr(Message.Content);
            return true;
        }
