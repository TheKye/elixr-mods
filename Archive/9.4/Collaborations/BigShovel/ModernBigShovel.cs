...
namespace Eco.Mods.TechTree
{
    ...
    {
        // Static values
        private static IDynamicValue        caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(ModernBigShovelItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(10, typeof(SelfImprovementSkill), typeof(ModernBigShovelItem), new ModernBigShovelItem().UILink()));
