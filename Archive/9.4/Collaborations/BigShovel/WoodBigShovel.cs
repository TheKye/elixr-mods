...
namespace Eco.Mods.TechTree
{
    ...
    {
        // Static values
        private static IDynamicValue    caloriesBurn        = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(WoodenBigShovelItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(20, typeof(SelfImprovementSkill), typeof(WoodenBigShovelItem), new WoodenBigShovelItem().UILink()));
