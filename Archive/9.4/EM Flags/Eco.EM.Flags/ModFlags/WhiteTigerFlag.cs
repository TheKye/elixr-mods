...
namespace Eco.EM.CustomFlags
{
    ...
    public partial class WhiteTigerFlagObject : BaseFlagObject, IRepresentsItem
    {
    ...
    {
        public override LocString DisplayDescription => Localizer.DoStr("The White Tiger Flag on a beautifuly hand crafted piece of cloth held up by a well crafted stand. Display it out front of your house, on your town hall or wherever you like!");
    ...
    */
    ...
    [Serializable]
    public abstract class WhiteTigerFlagComponent : FlagComponent
    {
        protected WhiteTigerFlagComponent() { }
        [Eco, ClientInterfaceProperty, GuestHidden] public WhiteTigerFlag FlagOption { get; set; } = WhiteTigerFlag.WhiteTiger;
