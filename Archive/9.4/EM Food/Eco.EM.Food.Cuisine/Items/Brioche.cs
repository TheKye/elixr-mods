...
namespace Eco.EM.Food.Cuisine
{
    ...
    public partial class BriocheItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(BriocheItem), "Brioche", calories: 750, carbs: 14, fat: 6, protein: 4, vitamins: 4);
    ...
    public partial class BriocheRecipe : RecipeFamily, IConfigurableRecipe
    {
        static RecipeDefaultModel Defaults => new()
        {
            ...
            IngredientList = new()
            {
                new EMIngredient("FlourItem", false, 6),
                new EMIngredient("YeastItem", false, 3)
            },
            ProductList = new()
            {
                new EMCraftable("BriocheItem", 2),
            },
