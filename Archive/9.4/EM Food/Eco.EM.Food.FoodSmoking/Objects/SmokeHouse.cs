...
namespace Eco.EM.Food.FoodSmoking
{
 ...
 typeof(AdvancedCookingUpgradeItem),})]
    public partial class SmokehouseItem : WorldObjectItem<SmokehouseObject>, IRepresentsItem
    {
        ...
        [TooltipChildren] public static HomeFurnishingValue HousingVal => new(){ Category = HomeFurnishingValue.RoomCategory.Kitchen, SkillValue = 2, TypeForRoomLimit = Localizer.DoStr("Storage"), DiminishingReturnPercent = 0.5f };
