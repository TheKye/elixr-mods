...
namespace Eco.EM.Food.FoodSmoking
{
    ...
    public partial class SmokedTurkeySurpriseItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(SmokedTurkeySurpriseItem), "Smoked Turkey Surprise", calories: 600, carbs: 5, fat: 7, protein: 7, vitamins: 5);
