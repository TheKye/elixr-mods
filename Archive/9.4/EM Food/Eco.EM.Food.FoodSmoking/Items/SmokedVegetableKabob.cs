...
namespace Eco.EM.Food.FoodSmoking
{
    ...
    public partial class SmokedVegetableKabobItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(SmokedVegetableKabobItem), "Smoked Vegetable Kabob", calories: 650, carbs: 5, fat: 5, protein: 5, vitamins: 5);
    ...
    public partial class SmokedVegetableKabobRecipe : RecipeFamily, IConfigurableRecipe
    {
        static RecipeDefaultModel Defaults => new()
        {
            ...
            IngredientList = new()
            {
                new EMIngredient("BeetItem", false, 10),
                new EMIngredient("CriminiMushroomsItem", false, 10),
                new EMIngredient("TomatoItem", false, 10),
            },
            ProductList = new()
            {
