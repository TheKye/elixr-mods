namespace Eco.EM
{
    ...
    public class NewTeleportationCommands : IChatCommandHandler
    {
        ...
        [ChatCommand("wipe-tp", "Backs up and wipes all teleportation logs, (this will reset day counters for limits)", ChatAuthorizationLevel.Admin)]
        ...
        [ChatCommand("tp-cost", "Sets the calorie cost to use tp.", ChatAuthorizationLevel.Admin)]
        ...
        [ChatCommand("tp-expiry", "Sets the length in seconds a request will be avaiable for before expiring.", ChatAuthorizationLevel.Admin)]
        ...
        [ChatCommand("tp-cooldown", "Teleport to a friend. Admins can use this to teleport to specific co-ordinates", ChatAuthorizationLevel.Admin)]
        ...
        [ChatCommand("tp", "Teleport to a friend. Admins can use this to teleport to specific co-ordinates", ChatAuthorizationLevel.User)]
        ...
        [ChatCommand("tpa", "Accept the last requested teleport", ChatAuthorizationLevel.User)]
