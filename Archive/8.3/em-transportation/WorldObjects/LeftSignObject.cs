namespace Eco.Mods.TechTree
{
    ...
    public partial class LeftSignObject :
        WorldObject,
        IRepresentsItem
    {
    ...
    [Serialized]
    [Weight(600)]
    public partial class LeftSignItem :
        WorldObjectItem<LeftSignObject>
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Keep Left Sign"); } }
    ...
    public class LeftSignRecipe : Recipe
    {
        public LeftSignRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(LeftSignRecipe), Item.Get<LeftSignItem>().UILink(), 5, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));
            this.Initialize(Localizer.DoStr("Keep Left Sign"), typeof(LeftSignRecipe));
