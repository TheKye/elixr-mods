namespace Eco.Mods.TechTree
{
    ...
    public partial class DualArrowObject :
        WorldObject,
        IRepresentsItem
    {
    ...
    public partial class DualArrowItem :
        WorldObjectItem<DualArrowObject>
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Dual Arrow"); } }
    ...
    public class DualArrowRecipe : Recipe
    {
        public DualArrowRecipe()
        {
            Products = new CraftingElement[]
            {
                new CraftingElement<DualArrowItem>(10)
            };
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(DualArrowRecipe), Item.Get<DualArrowItem>().UILink(), 5, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));
