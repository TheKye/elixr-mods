...
{ 
    ...
    public class WaterBucketRecipe : Recipe
    {
        public WaterBucketRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(WaterBucketRecipe), Item.Get<BucketOfWaterItem>().UILink(), 5, typeof(HewingSkill), typeof(HewingFocusedSpeedTalent), typeof(HewingParallelSpeedTalent));
    ...
    public class BucketRecipe : Recipe
    {
        public BucketRecipe()
        {
            ...
            this.ExperienceOnCraft = 2;
            this.CraftMinutes = CreateCraftTimeValue(typeof(BucketRecipe), Item.Get<BucketItem>().UILink(), 15, typeof(HewingSkill), typeof(HewingFocusedSpeedTalent), typeof(HewingParallelSpeedTalent));
