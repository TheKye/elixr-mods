...
namespace Eco.EM.Food.FoodSmoking
{
    ...
    public partial class MeatFiredPizzaItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(MeatFiredPizzaItem), "Meat Pizza", shelflife: 24, calories: 1250, carbs: 10, fat: 7, protein: 9, vitamins: 3);
