...
namespace Eco.EM.Food.FoodSmoking
{
    ...
    public partial class SmokedHareSurpriseItem : FoodItem, IConfigurableFoodItem
    {
        ...
        private static readonly FoodItemModel defaults = new(typeof(SmokedHareSurpriseItem), "Smoked Hare Surprise", shelflife: 24, calories: 600, carbs: 5, fat: 7, protein: 7, vitamins: 5);
