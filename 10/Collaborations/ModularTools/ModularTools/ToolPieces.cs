...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ToolPieceItem : Item
    {
        ...
        {
            var selectedItem = player.User.Inventory.Toolbar.SelectedItem as RepairableItem;
            ...
            if (selectedItem.GetDurability() == 100) return $"You don't need to repair your {selectedItem.DisplayName}, it is fully repaired.";
