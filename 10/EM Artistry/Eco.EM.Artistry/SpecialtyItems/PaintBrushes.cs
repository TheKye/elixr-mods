...
using Item = Eco.Gameplay.Items.Item;
...
namespace Eco.EM.Artistry
{
    ...
    public abstract class PaintBrushToolItem : ToolItem
    {
        ...
        public override ToolCategory ToolCategory => ToolCategory.Hammer;
...
#nullable disable
            ...
            switch (string.IsNullOrWhiteSpace(Color))
            {
                case true:
                    ...
                    foreach (var i in inventory.AllInventories.AllStacks())
                    {
                        if (i.Item.DisplayName.NotTranslated.Equals(requiredPaint.DisplayName.NotTranslated))
                        {
                            paint = i.Item;
                            break;
                        }
        ...
        public override bool IsValidFor(Item item)
        {
            ...
            return item is not LogItem && blockItem != null && Block.Is<Constructed>(blockItem.OriginType);
        }
    }
    ...
    [Serialized]
    [LocDisplayName("Dark Red Paint Brush")]
    [MaxStackSize(1)]
    [Category("Tool")]
    public partial class DarkRedPaintBrushItem : PaintBrushToolItem
    {
        public override string Color => "DarkRed";
    }
