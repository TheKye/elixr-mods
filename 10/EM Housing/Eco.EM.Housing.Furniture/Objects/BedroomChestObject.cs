...
namespace Eco.EM.Housing.Furniture
{
    ...
    [MaxStackSize(100)]
    [Tag("Housing")]
    [LocDescription("A Chest For Storing your personal items.")]
    public partial class BedroomChestItem : WorldObjectItem<BedroomChestObject>, IConfigurableHousing
    {
        ...
        public static HomeFurnishingValue HousingVal => EMHousingResolver.Obj.ResolveHomeValue(typeof(BedroomChestItem));
