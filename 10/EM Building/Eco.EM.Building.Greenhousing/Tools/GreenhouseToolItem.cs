...
namespace Eco.EM.Building.Greenhousing
{
    ...
    public class GreenhouseKitItem : SoilSamplerItem, IInteractor
    {

        [Interaction(InteractionTrigger.LeftClick, "Test Soil")]
        public void TestGreenhouse(Player context, InteractionTriggerInfo triggerInfo, InteractionTarget target)
        {
            if (target.IsBlock)
            {
